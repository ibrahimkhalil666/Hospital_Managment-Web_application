                    ...
                    <tbody>
                        <?php                         
                           ...
                           ;
                            ...
                            if ($stmt = $con->prepare("SELECT patient.fullname,patient.gender,patient.age,patient.email,patient.city,patient.address,patient.date FROM `patient` where patient.ver=1")) {
                                $stmt->execute();
