        ...
        <div class="col-md-4">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form class="form-login" action = "func.php" method = "post">
                <div class="row">
                ...
                <center><input type="submit" id="inputbtn" name="login_submit" value="Login" class="btn btn-primary"><span><a href="pateint-sign.php"> Sign-up</a></span></center>
              </form>
            </center>
            </div>
          </div>
